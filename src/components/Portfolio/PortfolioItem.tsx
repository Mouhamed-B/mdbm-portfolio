        ...
        <div className="portfolio-item w-100 h-100">
            <div className="portfolio-caption p-4 rounded-5 shadow-sm w-100 h-100 d-flex flex-column justify-content-between gap-3">
                ...
                <div className="row gap-2">
                    {props.link.length>0 && <a href={props.link} className='text-primary text-lg-start '><div className="d-flex gap-2"><i className="fa-solid fa-link fa-lg"></i><span className="small">Live</span></div></a> }
                    {props.repo.length>0 && <a href={props.repo} className='text-primary text-lg-start '><div className="d-flex gap-2"><i className="fa-brands fa-github fa-lg"></i><span>Github</span></div></a>}
                </div>
